    ...
    <>
      <section className="flex flex-col mb-24 mt-5">
        <div className="px-2 h-3/4 flex flex-col justify-center items-center">
          ...
          <div className="w-80 h-48 sm:w-128 sm:h-80 border rounded-2xl border-black relative grid overflow-hidden grid-cols-1 grid-rows-1 gap-2 items-center justify-items-center">
